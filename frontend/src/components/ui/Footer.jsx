        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-slate-50radient-to-br from-brand-500 to-purple-600 flex items-center justify-center shadow-lg">
                <Briefcase className="w-4 h-4 text-slate-900" />
              </div>
              <span className="text-slate-900 font-bold text-lg">JobMatch AI</span>
            </div>
          ...
          {/* Links */}
          <div>
            <h4 className="text-slate-900 font-semibold mb-4 text-sm">Khám phá</h4>
          ...
          <div>
            <h4 className="text-slate-900 font-semibold mb-4 text-sm">Dành cho bạn</h4>
            <ul className="space-y-2 text-sm">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-slate-900 font-semibold mb-4 text-sm">Liên hệ</h4>
