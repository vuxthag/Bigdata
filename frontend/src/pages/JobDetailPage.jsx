    ...
    return (
      <div className="section-container py-10 animate-fade-in">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="glass-card p-8 animate-pulse h-64 bg-slate-1000" />
          <div className="glass-card p-6 animate-pulse h-48 bg-slate-1000" />
        </div>
      </div>
    )
  }
  ...
  if (isError || !job) {
    return (
      <div className="section-container py-20 text-center">
        ...
        <h2 className="text-slate-900 text-xl font-bold mb-2">Không tìm thấy việc làm</h2>
  ...
  return (
    <div className="section-container py-10 animate-fade-in">
      <div className="max-w-4xl mx-auto">
        {/* Back button */}
        <Link to="/jobs" className="inline-flex items-center gap-1.5 text-slate-500 hover:text-slate-900 text-sm mb-6 transition-colors">
        ...
        <div className="glass-card p-6 sm:p-8 mb-6">
          <div className="flex flex-col sm:flex-row items-start gap-5">
            {/* Company logo */}
            <div className="w-16 h-16 rounded-2xl bg-slate-50radient-to-br from-brand-500/20 to-purple-500/20 border border-slate-200rand-500/20 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Meta row */}
              <div className="flex items-center gap-3 mt-3 flex-wrap text-sm text-slate-500">
          ...
          {/* Action buttons */}
          <div className="flex items-center gap-3 mt-6 pt-5 border-t border-slate-200 flex-wrap">
            <button
              onClick={handleApply}
              disabled={applied}
              className={applied
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-card p-6">
              <h2 className="text-slate-900 font-semibold text-lg mb-4">Mô tả công việc</h2>
          ...
          <div className="space-y-6">
            <div className="glass-card p-6">
              <h3 className="text-slate-900 font-semibold mb-4">Thông tin công ty</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-50rand-500/10 border border-slate-200rand-500/20 flex items-center justify-center">
            ...
            {/* Quick stats */}
            <div className="glass-card p-6">
              <h3 className="text-slate-900 font-semibold mb-4">Tổng quan</h3>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between text-slate-500">
                  <span>Loại</span>
                  <span className="text-slate-900">{job.job_type || 'Full-time'}</span>
                </div>
                <div className="flex justify-between text-slate-500">
